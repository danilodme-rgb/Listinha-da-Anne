...
export function App() {
  ...
  const [perfil, setPerfil] = useState<Perfil>(
    () => (localStorage.getItem(CHAVE_PERFIL) as Perfil) ?? 'anne',
  )
  const [aba, setAba] = useState<Aba>('anne')
  ...
  useEffect(() => { localStorage.setItem(CHAVE_PERFIL, perfil) }, [perfil])
